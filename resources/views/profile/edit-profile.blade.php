            ...
            <form action="">
                <div>
                    ...
                    <div class="shadow border flex px-3 items-center justify-between rounded-[50px] w-full h-[55px]">
                        <input type="text" placeholder="Fariel Putra Ariandi" id="nama" name="name"
                ...
                <div class="mt-4">
                    ...
                    <div class="shadow border flex px-3 items-center justify-between rounded-[50px] w-full h-[55px]">
                        <input type="text" placeholder="Contoh : Front End Developer" id="posisi" name="position"
                            class="h-full rounded-2xl w-full outline-none" />
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="shadow border flex px-3 items-center justify-between rounded-[50px] w-full h-[55px]">
                        <input type="text" placeholder="Contoh : Saya merupakan web developer ...." id="deskripsi"
                            name="description" class="h-full rounded-2xl w-full outline-none" />
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex items-center flex-wrap gap-3">
                        <input type="text" placeholder="Contoh : Photoshop" id="skill"
                            class="w-[20rem] shadow border px-3 rounded-[50px] h-[55px] rounded-2xl outline-none" />
                        <span
                    ...
                    <div class="flex items-center gap-3" id="skillTambah"></div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="shadow border flex px-3 items-center justify-between rounded-[50px] w-full h-[55px]">
                        <input type="number" inputmode="numeric" placeholder="Contoh : 08117700068" id="nohp"
                            name="nohp" class="h-full rounded-2xl w-full outline-none" />
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="shadow border flex px-3 items-center justify-between rounded-[50px] w-[15rem] h-[55px]">
                        <input type="number" inputmode="numeric" placeholder="Contoh : 2006-2007" id="year" name="year"
                            class="h-full rounded-2xl w-full outline-none" />
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="shadow border flex px-3 items-center justify-between rounded-[50px] w-full h-[55px]">
                        <input type="text" placeholder="Contoh : Kepala Divisi Tblkson" id="position" name="position"
                            class="h-full rounded-2xl w-full outline-none" />
                    </div>
                </div>
